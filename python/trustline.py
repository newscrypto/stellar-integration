...
# Create NWC asset object for public network
...
transaction = (
    TransactionBuilder(
        ...
        # Add a change trust operation to the transaction
        # Add NWC asset code and NWC issuer
        .append_change_trust_op(
        asset_code=nwcAsset.code, asset_issuer=nwcAsset.issuer
    )
